                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                         ...
                         <?php
                          ...
                          <a class="btn btn-info" href="<?php echo base_url("Dashboard/excelgeneratecounntry")?>"  type="submit">Download excel Format</a>
                           <form class="cmxform form-horizontal tasi-form type_box_lab" method="post" action="<?php echo base_url("Dashboard/addcountrycodes")?>" enctype="multipart/form-data" >
